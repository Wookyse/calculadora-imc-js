...
function calcIMC(inputPeso, inputAltura) {
  ...
  if (calc < 18.5) {
    ...
    if (svg == true) {
      ...
      svg.setAttribute('src', './icons/abaixo-do-peso.svg');
    }
    ...
    if (svg == true) {
      ...
      svg.setAttribute('src', './icons/sobrepeso.svg');
    }
    ...
    if (svg == true) {
      ...
      svg.setAttribute('src', './icons/obesidade-grau-i.svg');
    }
    ...
    if (svg == true) {
      ...
      svg.setAttribute('src', './icons/obesidade-grau-ii.svg');
    }
    ...
    if (svg == true) {
      ...
      svg.setAttribute('src', './icons/obesidade-grau-iii.svg');
    }
